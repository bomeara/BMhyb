...
[![Build Status](https://travis-ci.org/bomeara/BMhyb.svg)](https://travis-ci.org/bomeara/BMhyb) [![codecov](https://codecov.io/gh/bomeara/BMhyb/branch/master/graph/badge.svg)](https://codecov.io/gh/bomeara/BMhyb) [![Github Open Issues](https://img.shields.io/github/issues-raw/bomeara/BMhyb.svg)](https://github.com/bomeara/BMhyb/issues) [![Github Closed Issues](https://img.shields.io/github/issues-closed-raw/bomeara/BMhyb.svg)](https://github.com/bomeara/BMhyb/issues?q=is%3Aissue+is%3Aclosed) <img class="badge" src="https://www.r-pkg.org/badges/version/BMhyb"> <img class="badge" src="http://cranlogs.r-pkg.org/badges/grand-total/BMhyb">
...
Only some hybrid networks can be analyzed using this framework. Basically, each lineage must come from no more than one hybridization event. 
